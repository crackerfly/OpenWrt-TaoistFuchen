...
return view.extend({
	...
	render: function(data) {
		...
		var m = new form.Map('fakesip', _('FakeSIP'),
			_('Router-wide UDP DPI obfuscation using the TaoistFuchen-maintained FakeSIP 0.9.4. It adds a SIP-looking decoy to early UDP packets; it is not a VPN, proxy, or encryption layer.'));
