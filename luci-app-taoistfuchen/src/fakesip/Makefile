...
# TaoistFuchen-maintained release defaults. OpenWrt supplies the target
# compiler, flags, and staging paths on the make command line.
VERSION ?= 0.9.4
STATIC ?= 0
...
.PHONY: all compile debug clean install uninstall
