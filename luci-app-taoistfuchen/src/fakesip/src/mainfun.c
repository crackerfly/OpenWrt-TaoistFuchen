...
int main(int argc, char *argv[])
{
    ...
    if (res < 0) {
        ...
        /* A dual-stack setup may have installed one address family's rules
         * before the other family fails. Always remove partial firewall state
         * before tearing down the queue. */
