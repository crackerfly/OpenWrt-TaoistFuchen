...
- Corresponding source archive:
  `third_party/sources/FakeSIP-TaoistFuchen-0.9.4.tar.gz`
- Source archive SHA-256:
  `c0ecbb6836a24d273b57eaf2faaf63dd4535d9dc2e0ad3d196259b7f7008da6b`
...
The 0.9.4 maintenance delta is intentionally small:
...
`-p`/`-P` UDP port filters. Version 0.9.4 retains one known limitation: it does
...
FakeSIP 0.9.4 is built through LuCI's standard `src/Makefile` integration. The
